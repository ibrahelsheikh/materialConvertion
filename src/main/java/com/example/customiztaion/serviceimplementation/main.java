...
public class main {
    public static void main(String[] args) {
        ...
        params.INTERNAL_SHEET_NUMBER_OF_RIBS = 3;
        params.INTERNAL_SHEET_PURITY_DEGREE = 99.5;

        params.EXTERNAL_SHEET_TYPE = null;
        params.EXTERNAL_SHEET_COLOR_CODE = "RAL7016";
        params.EXTERNAL_SHEET_THICKNESS = 1.0;
        params.EXTERNAL_SHEET_NUMBER_OF_RIBS = 4;
        params.EXTERNAL_SHEET_PURITY_DEGREE = 98.0;
